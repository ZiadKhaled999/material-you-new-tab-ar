...
const menuWidths = {
    ...
    sl: "470px",
    np: "430px",
    ar: "480px", // Estimated width for Arabic - likely wider due to script characteristics
...
const numberMappings = {
    ...
    "ar": { "0": "٠", "1": "١", "2": "٢", "3": "٣", "4": "٤", "5": "٥", "6": "٦", "7": "٧", "8": "٨", "9": "٩" }, // Eastern Arabic numerals
...
function localizeNumbers(text, language) {
    ...
    const specialDecimalLanguages = ["cs", "it", "pt", "ru", "tr", "vi", "uz", "es", "ko", "idn", "fr", "az", "sl", "hu","ar"]; // Add more languages here as needed
...
function applyLanguage(lang) {
   ...
   if (lang === "vi") {
       ...
       loadFont("https://fonts.googleapis.com/css2?family=Noto+Sans+Arabic&display=swap");
       root.style.setProperty("--main-font-family", `"Noto Sans Arabic", ${commonFontStack}`);
       document.body.classList.add("lang-ar"); // Apply special styles for Arabic
   }
    else {
